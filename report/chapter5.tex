...
Vector Database & Pinecone Serverless (us-east-1, cosine) \\
Document Database & MongoDB Atlas M0 (AWS us-east-1) \\
Backend Hosting & Render (Free tier, Docker) \\
Frontend Hosting & Vercel (Free tier, Edge network) \\
Encryption & AES-256-CBC via \texttt{cryptography} library \\
